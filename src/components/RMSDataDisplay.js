                ...
                props.isLoading ?
                    ...
                    <Paper>
                        ...
                        <Box sx={{ padding: "10px" }}>
                            ...
                            <Button startIcon={<AssessmentIcon />} sx={{ margin: '5px' }} onClick={props.handleCreateReport} variant={'contained'} disabled={props.isProcessingData || props.rows.length === 0} >Buat Laporan</Button>
                        </Box>
                    </Paper>
            }
        </Box>
